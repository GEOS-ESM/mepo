...
import mepo3.command.clone as mepo_clone
import mepo3.command.list as mepo_list
import mepo3.command.status as mepo_status
import mepo3.command.compare as mepo_compare
import mepo3.command.develop as mepo_develop
import mepo3.command.checkout as mepo_checkout
import mepo3.command.branch_list as mepo_branch_list
import mepo3.command.branch_create as mepo_branch_create
import mepo3.command.branch_delete as mepo_branch_delete
import mepo3.command.tag_list as mepo_tag_list
import mepo3.command.tag_create as mepo_tag_create
import mepo3.command.tag_delete as mepo_tag_delete
import mepo3.command.fetch as mepo_fetch
import mepo3.command.pull as mepo_pull
import mepo3.command.push as mepo_push
import mepo3.command.diff as mepo_diff
import mepo3.command.whereis as mepo_whereis
...
class TestMepoCommands(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.output_clone_status = cls.__get_saved_output(
            "mepo3/output_clone_status.txt"
        )
